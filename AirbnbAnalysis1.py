...
st.set_page_config(page_title="AirBnb-Analysis by SRINIVASAN!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\gpdha\guvids\Airbnb")
